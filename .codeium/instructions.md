...
This guide helps contributors use Codeium (an AI assistant) effectively when working on this repository, while maintaining code quality and adhering to [project standards](/.github/copilot-instructions.md).
